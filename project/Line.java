...
public class Line 
{
	...
	/**
	 * Sets the layer of a line, allowing us to hide it while the ball moves, making 
	 * the game nicer and smoother.
	 */
	...
	/**
	 * This method allows us to unhide the line, reappering on the screen.
	 */
